...
var playCard = function playCard(i) {
	// player.play(i);
	console.log('playCard', i);
};

var placeCard = function placeCard(i) {
	// player.place(i);
	console.log('placeCard', i);
};

var attack = function attack(i) {
...
var attack = function attack(attackerIndex, attackedIndex) {
	fetch(host + api + 'playCard', {
		method: method,
		headers: headers,
		body: JSON.stringify({ attackerIndex: attackerIndex, attackedIndex: attackedIndex })
	}).then(function (response) {
		return response.json();
	}, function (err) {
		console.log('err', err);
...
var playCard = function playCard(index) {
	return new Promise(function (resolve, reject) {
		fetch(host + api + 'playCard', {
			method: method,
			headers: headers,
...
var addCard = function addCard(opponent, battlefield) {
	var cardInfo = arguments.length <= 2 || arguments[2] === undefined ? genericCard : arguments[2];
...
var updateUi = function updateUi(state) {
	...
	for (var i = 0; i < state.enemy.hand; i++) {
		addCard(true, false);
	}
