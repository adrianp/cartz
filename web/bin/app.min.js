...
document.getElementById('play').addEventListener('click', function () {
	...
	net.joinGame(gameName).then(function (resp) {
		if (resp.joined) {
...
},{"./game.js":3,"./net.js":4,"./ui.js":5}],3:[function(require,module,exports){
'use strict';
...
var gameId = '';
var userId = '';
var init = function init(id, uId) {
	gameId = id;
	userId = uId;
};

var updateGameState = function updateGameState() {
	net.getState(gameId, userId).then(function (state) {
		cs = state;
		var stateEv = new CustomEvent('stateChanged', { 'detail': state });
		document.dispatchEvent(stateEv);
	});
};

var playCard = function playCard(cardId) {
	if (cs.turn === 'player' && cs.player.hand.some(function (card) {
		return card.id === cardId;
	})) {
		net.playCard(gameId, userId, cardId).then(function (resp) {
...
var attack = function attack(cardId, targetId) {
	if (cs.turn === 'player' && cs.player.played.some(function (card) {
		return card.id === cardId;
	})) {
		net.attack(gameId, userId, cardId, targetId).then(function (resp) {
...
var endTurn = function endTurn() {
	if (cs.turn === 'player') {
		net.endTurn(gameId, userId).then(function (resp) {
...
},{"./net.js":4}],4:[function(require,module,exports){
'use strict';

var host = 'http://192.168.2.121:8080';
var api = '/api/game/';
...
var joinGame = function joinGame(gameId) {
	return new Promise(function (resolve, reject) {
		...
		}, reject).then(function (body) {
			return resolve(body);
		}, reject);
	});
};

var attack = function attack(gameId, userId, attackerIndex, attackedIndex) {
...
var playCard = function playCard(gameId, userId, cardId) {
	return new Promise(function (resolve, reject) {
		fetch(host + api + 'play', {
			method: method,
			headers: headers,
...
var endTurn = function endTurn(gameId, userId) {
	return new Promise(function (resolve, reject) {
		fetch(host + api + 'pass', {
			method: method,
			headers: headers,
...
var getState = function getState(gameId, userId) {
	return new Promise(function (resolve, reject) {
...
var dom = require('./DOMaker.js');

document.addEventListener('stateChanged', function (e) {
	console.log('e', e.detail);
});

var addCard = function addCard(cardInfos, opponent, battlefield) {
	//
	console.log(cardInfos);
	var card = dom({
		'type': 'div',
		'attributes': {
			'class': 'card' + (opponent === true ? ' flipped' : '')
		},
		'content': [dom({
			'type': 'div',
			'attributes': {
...
var createGameZone = function createGameZone() {
	var arena = dom({
		'type': 'div',
		'attributes': {
			'class': 'arena'
...
var updateUi = function updateUi(state) {
	...
	try {
		for (var _iterator = state.player.hand[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			playerHand = _step.value;
	...
	try {
		for (var _iterator2 = state.player.played[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
			playerPlayed = _step2.value;
	...
	try {
		for (var _iterator3 = state.enemy.played[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
			enemyPlayed = _step3.value;
	...
	for (var i = state.enemy.hand; i > 0; i--) {
...
},{"./DOMaker.js":1}],6:[function(require,module,exports){
(function (global){
/**
 * @license
